...
export const EXPERTS = [
  { id: 'e1', name: 'Dr. James Wright', email: 'j.wright@steelcorp.com', company: 'SteelCorp', title: 'VP Procurement', domain: 'Industry', spendingPool: 'Metals & Mining', category: 'Steel', geography: 'North America', waves: 4, surveysSent: 6, surveysResponded: 5, responsesAccepted: 4, status: 'Active' },
  { id: 'e2', name: 'Anna Kowalski', email: 'a.kowalski@mfg.pl', company: 'EuroMfg', title: 'Category Manager', domain: 'Industry', spendingPool: 'Metals & Mining', category: 'Steel', geography: 'Europe', waves: 2, surveysSent: 2, surveysResponded: 2, responsesAccepted: 1, status: 'Active' },
  { id: 'e3', name: 'Raj Patel', email: 'r.patel@tata.com', company: 'Tata Steel', title: 'Head of Sourcing', domain: 'Industry', spendingPool: 'Metals & Mining', category: 'Steel', geography: 'Asia-Pacific', waves: 3, surveysSent: 4, surveysResponded: 3, responsesAccepted: 3, status: 'Active' },
  ...
  },
  {
    ...
    questions: [
      { id: 'q1', type: 'single_choice', required: true, text: 'How do you expect polypropylene contract prices to trend in Q3 2026?', options: ['Significantly higher (>15%)', 'Moderately higher (5–15%)', 'Flat (±5%)', 'Moderately lower (5–15%)', 'Significantly lower (>15%)'],
        attachment: {
          fileName: 'pp_price_benchmark_q1_2026.pdf',
          mimeType: 'application/pdf',
          summaryStatus: 'ai_complete',
          summarySource: 'ai',
          attachmentSummary: 'A benchmarking report comparing polypropylene contract price movements across Europe, Asia, and North America for Q4 2025–Q1 2026. Includes indexed price curves and feedstock cost correlation data for propylene and naphtha.',
        }
      },
      { id: 'q2', type: 'rating_scale', required: true, text: 'Rate propylene feedstock availability confidence for the next 6 months', scale: 5, labels: ['Very low', 'Very good'],
        attachment: {
          fileName: 'feedstock_capacity_utilisation.xlsx',
    ...
    responses: [
      { expertId: 'e1', expertName: 'Dr. James Wright', company: 'SteelCorp', submittedAt: '2026-02-22', answers: { q1: 'Moderately higher (5–15%)', q2: 3, q3: 'Propylene feedstock tight in Asia due to naphtha cracker constraints.' }, excluded: false, annotation: '', notes: {} },
      { expertId: 'e2', expertName: 'Anna Kowalski', company: 'EuroMfg', submittedAt: '2026-02-24', answers: { q1: 'Flat (±5%)', q2: 4, q3: null }, excluded: false, annotation: '', notes: {} },
      { expertId: 'e3', expertName: 'Raj Patel', company: 'Tata Steel', submittedAt: '2026-02-25', answers: { q1: 'Significantly higher (>15%)', q2: 2, q3: 'PDH plant outages in the Middle East adding pressure to propylene supply.' }, excluded: false, annotation: '', notes: {} },
      { expertId: 'e4', expertName: 'Sophie Dubois', company: 'ArcelorMittal', submittedAt: '2026-02-28', answers: { q1: 'Moderately higher (5–15%)', q2: 3, q3: null }, excluded: false, annotation: '', notes: {} },
      { expertId: 'e5', expertName: 'Carlos Mendez', company: 'Ternium', submittedAt: '2026-03-01', answers: { q1: 'Flat (±5%)', q2: 4, q3: 'LATAM demand recovery could absorb spare PP capacity.' }, excluded: false, annotation: '', notes: {} },
    ],
    reminders: [],
    emailStatus: [],
    amendments: [],
