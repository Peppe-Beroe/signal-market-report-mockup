...
export const EXPERTS = [
  { id: 'e1', name: 'Dr. James Wright', email: 'j.wright@steelcorp.com', company: 'SteelCorp', title: 'VP Procurement', domain: 'Industry', spendingPool: 'Metals & Mining', category: 'Steel', geography: 'North America', tags: ['Tier 1', 'NA Region'], waves: 4, surveysSent: 6, surveysResponded: 5, responsesAccepted: 4, status: 'Active' },
  { id: 'e2', name: 'Anna Kowalski', email: 'a.kowalski@mfg.pl', company: 'EuroMfg', title: 'Category Manager', domain: 'Industry', spendingPool: 'Metals & Mining', category: 'Steel', geography: 'Europe', tags: ['EU Region'], waves: 2, surveysSent: 2, surveysResponded: 2, responsesAccepted: 1, status: 'Active' },
  { id: 'e3', name: 'Raj Patel', email: 'r.patel@tata.com', company: 'Tata Steel', title: 'Head of Sourcing', domain: 'Industry', spendingPool: 'Metals & Mining', category: 'Steel', geography: 'Asia-Pacific', tags: ['APAC Region', 'Tier 1'], waves: 3, surveysSent: 4, surveysResponded: 3, responsesAccepted: 3, status: 'Active' },
  { id: 'e4', name: 'Sophie Dubois', email: 's.dubois@arcelormittal.com', company: 'ArcelorMittal', title: 'Market Analyst', domain: 'Industry', spendingPool: 'Metals & Mining', category: 'Flat Steel', geography: 'Europe', tags: ['EU Region'], waves: 1, surveysSent: 1, surveysResponded: 1, responsesAccepted: 0, status: 'Active' },
  { id: 'e5', name: 'Carlos Mendez', email: 'c.mendez@ternium.com', company: 'Ternium', title: 'Procurement Director', domain: 'Industry', spendingPool: 'Metals & Mining', category: 'Steel', geography: 'Latin America', tags: ['LATAM Region', 'Tier 1'], waves: 2, surveysSent: 3, surveysResponded: 2, responsesAccepted: 2, status: 'Active' },
  { id: 'e6', name: 'Linda Park', email: 'l.park@posco.com', company: 'POSCO', title: 'Strategic Buyer', domain: 'Industry', spendingPool: 'Metals & Mining', category: 'Steel', geography: 'Asia-Pacific', tags: ['APAC Region'], waves: 1, surveysSent: 1, surveysResponded: 0, responsesAccepted: 0, status: 'Opted-out' },
];
